...
public class AdminSachbearbeiterErzeugenAAS extends JPanel  {
		...
		btnOk.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if (rdbtnAdministrator.isSelected() || rdbtnSachbearbeiter.isSelected()) {
					System.out.println(benutzerNameEingabe.getText() + eingabePasswort.getText() + berechtigung);
					kontrolle.trageNeuenNutzerein(benutzerNameEingabe.getText(), eingabePasswort.getText(), berechtigung);
				} else {
